          ...
          >
            {items.map((service) => (
              <div key={service.id} className="h-full">
                ...
                >
                  <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-border/80 bg-card transition-all duration-300 group-hover:-translate-y-1">
                    <MediaImage
                      media={service.image}
                      alt={service.title}
                      fill
